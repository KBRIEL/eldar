...
public class Sistema {
	...
	private boolean validar(Tarjeta tarjeta,double costo) {
		...
		return tarjeta.costoDelPago(costo)>1000;
	}
	...
	public double tasaDeTarjeta(Tarjeta tarjeta) {
		return tarjeta.tasaDeOperacion();
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(sistema.tasaDeTarjeta(visa));
